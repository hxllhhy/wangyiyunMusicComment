...
class music:
    ...
    def get_encSecKey(self):
        #获取encSecKey
        encSecKey = ""
        return encSecKey
    ...
    def get_hotcomments(self, url):
        ...
        f = open('/home/hehanyue/HotComments.txt', 'w', encoding='utf-8')
    ...
    def get_allcomments(self, url):
        ...
        f = open('/home/hehanyue/AllComments.txt', 'w', encoding='utf-8')
        present_page = 0
...
mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_553755659?csrf_token")
